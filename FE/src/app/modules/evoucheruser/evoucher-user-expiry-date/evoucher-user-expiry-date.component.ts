...
@Component({
  selector: 'app-evoucher-user-expiry-date',
  templateUrl: './evoucher-user-expiry-date.component.html',
  styleUrls: ['./evoucher-user-expiry-date.component.css']
})
export class EvoucherUserExpiryDateComponent extends BaseGridComponent<View_EVoucherUser, EvoucherUserCodeFilterModel
